...
if ($method == 'POST') {
	...
	$qry = "select tbl_users.username,".
            ...
            "tbl_ratings_table.rating_title,".            
            "tbl_ratings_table.rating_desc,".
            "tbl_ratings_table.rating_date ".
            "from tbl_ratings_table,tbl_users where ".
            "tbl_ratings_table.user_id = tbl_users.user_id and tbl_ratings_table.rating_type ='gen' and tbl_ratings_table.id_school = $school_id";
